...
<html lang="en">
  <head>
    ...
    <title>Vanier - Web Design Specialist <Program-jessica></Program-jessica></title>
  </head>
  <body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-4"></div>
            <div class="col-4"><img src="assets/images/college.jpg" alt="COllege" width="100%"></div>
            <div class="col-4"></div>
        </div>
        <h1>Vanier - Web Design Specialist Program</h1>
        <p>
